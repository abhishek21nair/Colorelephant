...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 07, 2017 at 09:12 AM
...
(1, 33, 1, 1, 0, '0000-00-00 00:00:00', '0000-00-00 00:00:00');
...
CREATE TABLE `category_of_interests` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` int(11) NOT NULL,
...
CREATE TABLE `job_classification_lookup` (
  `id` int(10) UNSIGNED NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `created_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00',
  `updated_at` timestamp NOT NULL DEFAULT '0000-00-00 00:00:00'
...
(2, 33, 'abhishek', 'nair', 0, 0, 0, 0, '', '', '', '', '', '', '2017-08-07 00:27:21', '2017-08-07 00:27:21');
...
(1, 'admin@localhost.com', '$2y$10$ZpH5R.wYM7Rg9momNTDZ7e/yT9UWTgDsWzp01G2P29EV3cqvkIWq6', 1, 'njA3dq3xm9DvA5NzbfyPbqU2l0ya0ikcYPAA9rPebQ8SRGxZvfquj8W7xlpg', '2015-04-04 13:54:07', '2017-08-07 00:59:49'),
...
(33, 'abhishek21nair@gmail.com', '$2y$10$nJTDGlkooc3iG3s9FznY6eKwqtnjigYls/TWknIDBRlI77pKD0xfW', 0, 'TX4EjjnlhirYGKxQk4tqr00plEioVvUSBpdiLIkh2V1pSC1R5oPPl3B0zqto', '2017-08-07 00:27:21', '2017-08-07 01:40:25');
...
(1, 'Php Devloper', 'Pune', '08/09/2017', '11/09/2017', 1, 4, 14, '4.5', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry''s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus PageMaker including versions of Lorem Ipsum.', 0, 1, '2017-08-07', '2017-08-07 00:25:30', '2017-08-07 00:25:52');
...
--
-- Indexes for table `applicants_vacancies`
--
ALTER TABLE `applicants_vacancies`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `categories_lookup`
--
ALTER TABLE `categories_lookup`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `category_of_interests`
--
ALTER TABLE `category_of_interests`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `companies_lookup`
--
ALTER TABLE `companies_lookup`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `countries_lookup`
--
ALTER TABLE `countries_lookup`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `job_classification_lookup`
--
ALTER TABLE `job_classification_lookup`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `applicants_vacancies`
--
ALTER TABLE `applicants_vacancies`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
--
-- AUTO_INCREMENT for table `categories_lookup`
--
ALTER TABLE `categories_lookup`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=27;
--
-- AUTO_INCREMENT for table `category_of_interests`
--
ALTER TABLE `category_of_interests`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
...
ALTER TABLE `certificates`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `companies_lookup`
--
ALTER TABLE `companies_lookup`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
-- AUTO_INCREMENT for table `countries_lookup`
--
ALTER TABLE `countries_lookup`
...
ALTER TABLE `experiences`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `job_classification_lookup`
--
ALTER TABLE `job_classification_lookup`
...
ALTER TABLE `languages`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `languages_lookup`
--
ALTER TABLE `languages_lookup`
